...
public class ClientesProvider extends ContentProvider {
    ...
    static {
        ...
        uriMatcher.addURI("com.example.android.contentproviders", "clientes", CLIENTES);
        uriMatcher.addURI("com.example.android.contentproviders", "clientes/#", CLIENTES_ID);
    }
